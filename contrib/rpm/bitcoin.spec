...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 59443
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 59444
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 15332
	%{_sbindir}/semanage port -d -p tcp 598443
	%{_sbindir}/semanage port -d -p tcp 59444
	for selinuxvariant in %{selinux_variants}; do
