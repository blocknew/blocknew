...
Blocknew-Qt: Address Book, then New Address...
...
Drag and drop support for blocknew: URIs on web pages.
...
signmessage/verifymessage : new RPC commands to sign a message with one of your private keys or verify that a message signed by the private key associated with a blocknew address.
