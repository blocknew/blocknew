...
- #10651 `cef4b5c` Verify binaries from bitcoincore.org and blocknew.org (TheBlueMatt)
- #10786 `ca4c545` Add PR description to merge commit in github-merge.py (sipa)
- #10812 `c5904e8` [utils] Allow blocknew-cli's -rpcconnect option to be used with square brackets (jnewbery)
...
- #9999 `a328904` [LevelDB] Plug leveldb logs to blocknew logs (NicolasDorier)
...
- #10958 `659c096` Update to latest Blocknew patches for LevelDB (sipa)
