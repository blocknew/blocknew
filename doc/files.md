...
* blocknew.conf: contains configuration settings for blocknewd or blocknew-qt
* blocknewd.pid: stores the process id of blocknewd while running
...
* debug.log: contains debug information and general logging generated by blocknewd or blocknew-qt
